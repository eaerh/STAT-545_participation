...
gapminder %>% 
  group_by(country) %>% 
  mutate(growth = pop - first(pop[year == 1972]))
```
...
```
    ...
    ## # A tibble: 1,704 x 7
    ##    country     continent  year lifeExp      pop gdpPercap popBill
...
1.  Compute the change in population from 1962 to 1972 for each country.

``` r
gapminder %>% 
  group_by(country) %>% 
  mutate(chnge = pop[year == 1972] - pop[year ==1962 ])
```

    ## # A tibble: 1,704 x 7
    ## # Groups:   country [142]
    ##    country     continent  year lifeExp      pop gdpPercap   chnge
    ##    <fct>       <fct>     <int>   <dbl>    <int>     <dbl>   <int>
    ##  1 Afghanistan Asia       1952    28.8  8425333      779. 2812377
    ##  2 Afghanistan Asia       1957    30.3  9240934      821. 2812377
    ##  3 Afghanistan Asia       1962    32.0 10267083      853. 2812377
    ##  4 Afghanistan Asia       1967    34.0 11537966      836. 2812377
    ##  5 Afghanistan Asia       1972    36.1 13079460      740. 2812377
    ##  6 Afghanistan Asia       1977    38.4 14880372      786. 2812377
    ##  7 Afghanistan Asia       1982    39.9 12881816      978. 2812377
    ##  8 Afghanistan Asia       1987    40.8 13867957      852. 2812377
    ##  9 Afghanistan Asia       1992    41.7 16317921      649. 2812377
    ## 10 Afghanistan Asia       1997    41.8 22227415      635. 2812377
    ## # ... with 1,694 more rows
